...
class BaseLeave(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Leave']] = 'Leave'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.LeaveActions[_PrismaModelT]':
        from .client import get_client

        return actions.LeaveActions[_PrismaModelT](client or get_client(), cls)
