...
SCHEMA_PATH = Path('F:/antigravity/student-portal/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\KIIT0001\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    leave: 'actions.LeaveActions[models.Leave]'
    ...
    def __init__(
        ...
        *,
        ...
        self.leave = actions.LeaveActions[models.Leave](self, models.Leave)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'F:/antigravity/student-portal/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.leave = LeaveBatchActions(self)
